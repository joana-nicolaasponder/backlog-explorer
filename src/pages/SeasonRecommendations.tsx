...
import { getSeasonalContext } from '../pages/lib/seasonUtils' // You can move your seasonal helper here
...
const SeasonRecommendations = () => {
  ...
  const handleGetRecommendation = async () => {
    ...
    const payload = { mode: 'seasonal', backlog: enrichedBacklog, season, holidays }
          ...
          <div className="mb-4 p-4 bg-base-200 rounded-lg whitespace-pre-wrap">
            {(() => {
              const introLine = recommendation
                .split('\n')
                .find((line) =>
                  /^(based on|given) the current season/i.test(line)
                )
